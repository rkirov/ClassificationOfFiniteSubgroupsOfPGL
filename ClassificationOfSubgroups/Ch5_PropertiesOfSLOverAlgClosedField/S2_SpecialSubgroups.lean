...
/--
The subgroup of matrices generated by the diagonal matrices `d`
-/
-- ANCHOR: SpecialSubgroups.D
...
/--
  The subgroup generated by the shear matrices `s`
-/
-- ANCHOR: SpecialSubgroups.S
