...
\subsubsection{Goal of the formalization of Fermat's Last Theorem}

The goal of the ongoing efforts of the formalization is to reduce the proof of Fermat's Last Theorem to results that were known in the 1980s such as \text{Mazur's Theorem}.
...
Morally, the goal of the formalization of Fermat's Last Theorem is to formalise much of Algebraic Number Theory, Algebraic Geometry, Arithmetic Geometry and so forth so that one day
