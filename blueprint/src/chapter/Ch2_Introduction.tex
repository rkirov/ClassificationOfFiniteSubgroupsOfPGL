...
\begin{definition}\lean{ProjectiveGeneralLinearGroup.SL_monoidHom_PGL}
...
\begin{lemma}
\lean{ProjectiveGeneralLinearGroup.center_SL_le_ker}
\uses{ProjectiveGeneralLinearGroup.SL_monoidHom_PGL}
\leanok
...
\begin{definition}\lean{ProjectiveGeneralLinearGroup.PSL_monoidHom_PGL}
    Let $\bar{\varphi} : \PSL_n(F) \rightarrow \PGL_n(F)$ be the lift of $\varphi$
\end{definition}

\begin{lemma}\lean{ProjectiveGeneralLinearGroup.Injective_PSL_monoidHom_PGL}
