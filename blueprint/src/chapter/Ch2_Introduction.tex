...
\begin{definition}\lean{Ch2_PGLIsoPSLOverAlgClosedField.ProjectiveGeneralLinearGroup.SL_monoidHom_PGL}
...
\uses{Ch2_PGLIsoPSLOverAlgClosedField.ProjectiveGeneralLinearGroup.SL_monoidHom_PGL}
\leanok
