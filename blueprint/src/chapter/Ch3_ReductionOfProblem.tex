\chapter{Reduction of classification of finite subgroups of $\PGL_2(\Fbar_p)$ to classification of finite subgroups of $\PSL_2(\Fbar_p)$}\label{Ch3_ReductionOfProblem}
...
From now on, we follow Christopher Butler's exposition of Dickson's classification of finite subgroups of $\SL_2(F)$ over an algebraically closed field $F$. Christopher has been kind enough to provide the $\LaTeX$ code so I could prepare this blueprint which crucially hinges on the result which his exposition covers.