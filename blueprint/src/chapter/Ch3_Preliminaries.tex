...
%  using it only for reference purposes as and when the results are subsequently cited. 
...
The orbit and the stabiliser of an element are closely related. 
...
\begin{remark}[Conjugate elements in Lean]
\label{conj_elem}
...
\begin{remark}[Internal direct product and complete lattice structure of subgroups]
