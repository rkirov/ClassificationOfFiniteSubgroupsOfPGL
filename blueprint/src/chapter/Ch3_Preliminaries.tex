...
\begin{remark}[Sylow $p$-subgroup in Lean]
    TODO
\end{remark}
...
\begin{lemma} 
\label{SpecialSubgroups.prod_mulEquiv_join_of_disjoint_of_normal} 
\lean{SpecialSubgroups.prod_mulEquiv_join_of_disjoint_of_normal}
\leanok
