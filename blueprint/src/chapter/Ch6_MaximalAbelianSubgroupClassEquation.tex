...
\begin{theorem}
  ...
  \uses{IsCommutative_centralizer_of_not_mem_center, MaximalAbelianSubgroups}
...
\uses{MaximalAbelianSubgroup.center_le, MaximalAbelianSubgroups, IsMaximalAbelian}
...
\end{theorem}
%SPLIT UP RESULT AND DEPENDENCY
\begin{proof}
...
\lean{noncenter_MaximalAbelianSubgroups}
\leanok
